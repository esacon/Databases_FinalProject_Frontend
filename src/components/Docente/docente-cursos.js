...
const DocenteCursos = () => {
  ...
  const idDocente = cookie.load('idDocente');
  ...
  const getCursosDocente = async () => {
    try {
      const response = await axios.get(DB_URL + `curso/doc/${periodo}/${idDocente}`);
        ...
        <div class="doccursou-align-left doccursou-clearfix doccursou-sheet doccursou-sheet-1">
          ...
          <div class="doccursou-clearfix doccursou-gutter-42 doccursou-layout-wrap doccursou-layout-wrap-1">
            <div class="doccursou-layout">
              <div class="doccursou-layout-row" id="cursosDocenteContainer">
                {
