...
const Estudiante = () => {
    ...
    <section class="estudiuu-clearfix estudiuu-image estudiuu-section-1" id="carousel_2e1d" data-image-width="3375" data-image-height="2250">
      <div class="estudiuu-clearfix estudiuu-sheet estudiuu-valign-middle estudiuu-sheet-1">
        <div class="estudiuu-align-left estudiuu-container-style estudiuu-group estudiuu-shape-rectangle estudiuu-white estudiuu-group-1">
          <div class="estudiuu-container-layout estudiuu-container-layout-1">
            <h1 class="estudiuu-text estudiuu-text-default estudiuu-text-1"> Bienvenido</h1>
            <p class="estudiuu-text estudiuu-text-2">¿Cómo le fue en su día estimado estudiante?</p>
          </div>
        </div>
      </div>
    </section>
    <section class="estudiuu-align-center-lg estudiuu-align-center-md estudiuu-align-center-sm estudiuu-align-center-xl estudiuu-align-left-xs estudiuu-clearfix estudiuu-grey-10 estudiuu-section-2" id="carousel_2469">
      <div class="estudiuu-clearfix estudiuu-sheet estudiuu-sheet-1">
        <h1 class="estudiuu-text estudiuu-text-default estudiuu-text-palette-2-base estudiuu-text-1">Servicios disponibles</h1>
        <div class="estudiuu-expanded-width estudiuu-list estudiuu-list-1">
          <div class="estudiuu-repeater estudiuu-repeater-1">
            <div class="estudiuu-align-left estudiuu-container-style estudiuu-list-item estudiuu-radius-26 estudiuu-repeater-item estudiuu-shape-round estudiuu-white estudiuu-list-item-1">
              <div class="estudiuu-container-layout estudiuu-similar-container estudiuu-container-layout-1"><span class="estudiuu-border-4 estudiuu-border-palette-2-light-2 estudiuu-icon estudiuu-icon-rounded estudiuu-radius-10 estudiuu-spacing-16 estudiuu-white estudiuu-icon-1"><svg class="estudiuu-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 512 512" ><use xmlnsXlink="http://www.w3.org/1999/xlink" xlinkHref="#svg-5562"></use></svg><svg class="estudiuu-svg-content" viewBox="0 0 512 512" x="0px" y="0px" id="svg-5562" ><g><g><path d="M224,0H74.667C33.493,0,0,33.493,0,74.667v362.667C0,478.507,33.493,512,74.667,512H96    c5.888,0,10.667-4.779,10.667-10.667c0-5.888-4.779-10.667-10.667-10.667H74.667c-29.397,0-53.333-23.936-53.333-53.333V74.667    c0-29.397,23.936-53.333,53.333-53.333H224c29.397,0,53.333,23.936,53.333,53.333v106.667c0,5.888,4.779,10.667,10.667,10.667    s10.667-4.779,10.667-10.667V74.667C298.667,33.493,265.173,0,224,0z"></path>
</g>
    ...
    <section class="estudiuu-align-center estudiuu-clearfix estudiuu-grey-10 estudiuu-section-3" id="sec-178d">
      <div class="estudiuu-clearfix estudiuu-sheet estudiuu-sheet-1">
        <h1 class="estudiuu-text estudiuu-text-default estudiuu-text-palette-2-base estudiuu-text-1">Conoce nuestro equipo</h1>
        <div class="estudiuu-expanded-width estudiuu-list estudiuu-list-1">
          <div class="estudiuu-repeater estudiuu-repeater-1">
            <div class="estudiuu-align-center estudiuu-container-style estudiuu-list-item estudiuu-repeater-item estudiuu-shape-rectangle estudiuu-white estudiuu-list-item-1">
              <div class="estudiuu-container-layout estudiuu-similar-container estudiuu-container-layout-1">
                <div class="estudiuu-border-4 estudiuu-border-palette-2-light-2 estudiuu-expanded-width estudiuu-image estudiuu-image-circle estudiuu-preserve-proportions estudiuu-image-1" alt="" data-image-width="206" data-image-height="206">
                  <div class="estudiuu-preserve-proportions-child" ></div>
                </div>
                <h4 class="estudiuu-text estudiuu-text-default estudiuu-text-2">Mariana Oquendo</h4>
                <p class="estudiuu-text estudiuu-text-default estudiuu-text-3"> Creative Leader</p>
              </div>
            </div>
            <div class="estudiuu-align-center estudiuu-container-style estudiuu-list-item estudiuu-repeater-item estudiuu-shape-rectangle estudiuu-white estudiuu-list-item-2">
              <div class="estudiuu-container-layout estudiuu-similar-container estudiuu-container-layout-2">
                <div class="estudiuu-border-4 estudiuu-border-palette-2-light-2 estudiuu-expanded-width estudiuu-image estudiuu-image-circle estudiuu-preserve-proportions estudiuu-image-2" alt="" data-image-width="206" data-image-height="206">
                  <div class="estudiuu-preserve-proportions-child" ></div>
                </div>
                <h4 class="estudiuu-text estudiuu-text-default estudiuu-text-4">Enrique Niebles</h4>
                <p class="estudiuu-text estudiuu-text-default estudiuu-text-5">Sales Manager</p>
              </div>
            </div>
            <div class="estudiuu-align-center estudiuu-container-style estudiuu-list-item estudiuu-repeater-item estudiuu-shape-rectangle estudiuu-white estudiuu-list-item-3">
              <div class="estudiuu-container-layout estudiuu-similar-container estudiuu-container-layout-3">
                <div class="estudiuu-border-4 estudiuu-border-palette-2-light-2 estudiuu-expanded-width estudiuu-image estudiuu-image-circle estudiuu-preserve-proportions estudiuu-image-3" alt="" data-image-width="206" data-image-height="206">
                  <div class="estudiuu-preserve-proportions-child" ></div>
                </div>
                <h4 class="estudiuu-text estudiuu-text-default estudiuu-text-6">Juan<br/>Prada
                </h4>
                <p class="estudiuu-text estudiuu-text-default estudiuu-text-7"> Web Developer</p>
              </div>
            </div>
            <div class="estudiuu-align-center estudiuu-container-style estudiuu-list-item estudiuu-repeater-item estudiuu-shape-rectangle estudiuu-white estudiuu-list-item-4">
              <div class="estudiuu-container-layout estudiuu-similar-container estudiuu-container-layout-4">
                <div class="estudiuu-border-4 estudiuu-border-palette-2-light-2 estudiuu-expanded-width estudiuu-image estudiuu-image-circle estudiuu-preserve-proportions estudiuu-image-4" alt="" data-image-width="626" data-image-height="417">
                  <div class="estudiuu-preserve-proportions-child" ></div>
                </div>
                <h4 class="estudiuu-text estudiuu-text-default estudiuu-text-8">Enrique Miranda</h4>
                <p class="estudiuu-text estudiuu-text-default estudiuu-text-9">Web Designer</p>
              </div>
            </div>
            <div class="estudiuu-align-center estudiuu-container-style estudiuu-list-item estudiuu-repeater-item estudiuu-shape-rectangle estudiuu-white estudiuu-list-item-5">
              <div class="estudiuu-container-layout estudiuu-similar-container estudiuu-container-layout-5">
                <div class="estudiuu-border-4 estudiuu-border-palette-2-light-2 estudiuu-expanded-width estudiuu-image estudiuu-image-circle estudiuu-preserve-proportions estudiuu-image-5" alt="" data-image-width="626" data-image-height="417">
                  <div class="estudiuu-preserve-proportions-child" ></div>
                </div>
                <h4 class="estudiuu-text estudiuu-text-default estudiuu-text-10">Santiago Poveda</h4>
                <p class="estudiuu-text estudiuu-text-default estudiuu-text-11">Web Designer</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="estudiuu-align-center estudiuu-clearfix estudiuu-expanded-width-xl estudiuu-palette-5-dark-3 estudiuu-section-4" id="carousel_d922">
      <div class="estudiuu-clearfix estudiuu-sheet estudiuu-valign-middle estudiuu-sheet-1">
        <div class="estudiuu-clearfix estudiuu-gutter-0 estudiuu-layout-wrap estudiuu-layout-wrap-1">
          <div class="estudiuu-gutter-0 estudiuu-layout">
            <div class="estudiuu-layout-row">
              <div class="estudiuu-align-left estudiuu-container-style estudiuu-layout-cell estudiuu-shape-rectangle estudiuu-size-27-lg estudiuu-size-27-md estudiuu-size-27-sm estudiuu-size-27-xs estudiuu-size-30-xl estudiuu-layout-cell-1">
                <div class="estudiuu-container-layout estudiuu-container-layout-1">
                  <h2 class="estudiuu-text estudiuu-text-1">Envia tus comentarios al administrador.</h2>
                </div>
              </div>
              <div class="estudiuu-align-left estudiuu-container-style estudiuu-layout-cell estudiuu-palette-2-base estudiuu-shape-rectangle estudiuu-size-30-xl estudiuu-size-33-lg estudiuu-size-33-md estudiuu-size-33-sm estudiuu-size-33-xs estudiuu-layout-cell-2">
                <div class="estudiuu-container-layout estudiuu-valign-middle-xl estudiuu-container-layout-2">
                  <div class="estudiuu-form estudiuu-form-1">
                    <form action="#" method="POST" class="estudiuu-clearfix estudiuu-form-spacing-30 estudiuu-form-vertical estudiuu-inner-form"  source="custom" name="form">
                      <div class="estudiuu-form-group estudiuu-form-name">
                        <label for="name-3b9a" class="estudiuu-form-control-hidden estudiuu-label" wfd-invisible="true">Name</label>
                        <input type="text" placeholder="Nombre" id="name-3b9a" name="name" class="estudiuu-border-2 estudiuu-border-no-left estudiuu-border-no-right estudiuu-border-no-top estudiuu-border-white estudiuu-input estudiuu-input-rectangle estudiuu-input-1" required=""/>
                      </div>
                      <div class="estudiuu-form-email estudiuu-form-group">
                        <label for="email-3b9a" class="estudiuu-form-control-hidden estudiuu-label" wfd-invisible="true">Email</label>
                        <input type="email" placeholder="Correo" id="email-3b9a" name="email" class="estudiuu-border-2 estudiuu-border-no-left estudiuu-border-no-right estudiuu-border-no-top estudiuu-border-white estudiuu-input estudiuu-input-rectangle estudiuu-input-2" required=""/>
                      </div>
                      <div class="estudiuu-form-group estudiuu-form-group-3">
                        <label for="text-160a" class="estudiuu-form-control-hidden estudiuu-label"></label>
                        <input type="text" id="text-160a" name="text" class="estudiuu-border-2 estudiuu-border-no-left estudiuu-border-no-right estudiuu-border-no-top estudiuu-border-white estudiuu-input estudiuu-input-rectangle estudiuu-input-3" placeholder="Asunto"/>
                      </div>
                      <div class="estudiuu-form-group estudiuu-form-message">
                        <label for="message-3b9a" class="estudiuu-form-control-hidden estudiuu-label" wfd-invisible="true">Message</label>
                        <textarea placeholder="Mensaje..." rows="4" cols="50" id="message-3b9a" name="message" class="estudiuu-border-2 estudiuu-border-no-left estudiuu-border-no-right estudiuu-border-no-top estudiuu-border-white estudiuu-input estudiuu-input-rectangle estudiuu-input-4" required=""></textarea>
                      </div>
                      <div class="estudiuu-align-left estudiuu-form-group estudiuu-form-submit">
                        <a href="#" class="estudiuu-active-palette-2-light-3 estudiuu-border-none estudiuu-btn estudiuu-btn-submit estudiuu-button-style estudiuu-hover-palette-2-light-3 estudiuu-text-active-black estudiuu-text-hover-black estudiuu-text-palette-2-base estudiuu-white estudiuu-btn-1">ENVIAR</a>
                        <input type="submit" value="submit" class="estudiuu-form-control-hidden" wfd-invisible="true"/>
                      </div>
                      <div class="estudiuu-form-send-message estudiuu-form-send-success" wfd-invisible="true"> Thank you! Your message has been sent. </div>
                      <div class="estudiuu-form-send-error estudiuu-form-send-message" wfd-invisible="true"> Unable to send your message. Please fix errors then try again. </div>
